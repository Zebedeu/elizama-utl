...
<section class="no-results not-found">
    ...
    <div class="page-content">
        ...
        <?php  /* translators: 1: Ready to publish your first post? Get started here */ ?>
        <p><?php printf(wp_kses(__('Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'elizama'), array('a' => array('href' => array()))), esc_url(admin_url('post-new.php'))); ?></p>
